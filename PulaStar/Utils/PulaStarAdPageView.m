...
#import "PulaStarAdPageView.h"

#define mainWidth           [[UIScreen mainScreen] bounds].size.width
#define defaultInterval     5
#define addBeyond           2

@interface PulaStarAdPageView()<UIScrollViewDelegate>
{
    __weak  id<PulaStarAdPageViewDelegate> delegate;
    NSTimer       *autoTimer;
...
@implementation PulaStarAdPageView
@synthesize delegate;
