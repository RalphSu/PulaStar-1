...
#import "PulaStar_Common_Common.h"

#define phonePrefix   @"1[3|4|5|7|8|][0-9]{9}"

@implementation PulaStar_Common_Common

+ (instancetype)sharedInstance
{
    static PulaStar_Common_Common *_sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[PulaStar_Common_Common alloc] init];
    });
