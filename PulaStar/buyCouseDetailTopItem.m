...
@interface buyCourseDetailTopItemCell ()
{
...
@implementation buyCourseDetailTopItemCell
...
- (void)setCourseItem:(NSString*)searchId courseNo:(NSString*)courseNo courseName:(NSString*)courseName coursePrice:(NSString*)coursePrice;
